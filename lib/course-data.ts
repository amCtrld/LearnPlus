...
export const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    steps: [
      {
        id: '2-1',
        question: 'Identify $u$ and $v$ where $f(x) = u \\cdot v$. What is $u$?',
        expectedAnswer: 'x^2 + 1',
        hint: '$u$ is the first factor in the product.',
      },
      {
        id: '2-2',
        question: 'What is $\\frac{du}{dx}$?',
        expectedAnswer: '2x',
      ...
      {
        id: '2-4',
        question: 'What is $\\frac{dv}{dx}$?',
        expectedAnswer: '3x^2 - 2',
        hint: 'Differentiate $v = x^3 - 2x$.',
      },
      {
        id: '2-5',
        question: 'Apply the product rule: $\\frac{d}{dx}(uv) = u\\frac{dv}{dx} + v\\frac{du}{dx}$. What is $f\'(x)$?',
        expectedAnswer: '(x^2 + 1)(3x^2 - 2) + (x^3 - 2x)(2x)',
        hint: 'Substitute $u$, $v$, $\\frac{du}{dx}$, $\\frac{dv}{dx}$ into the product rule formula.',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        id: '3-3',
        question: 'Apply the chain rule: $\\frac{df}{dx} = \\frac{df}{du} \\cdot \\frac{du}{dx}$. What is $f\'(x)$?',
        expectedAnswer: '4(3x^2 + 5)^3 * 6x',
        hint: 'First differentiate the outer function, then multiply by $\\frac{du}{dx}$.',
      },
      {
        id: '3-4',
        question: 'Simplify $f\'(x)$.',
        expectedAnswer: '24x(3x^2 + 5)^3',
        hint: 'Multiply $4 \\times 6x$ to get $24x$.',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        id: '4-5',
        question: 'Apply the quotient rule: $f\'(x) = \\frac{v \\cdot \\frac{du}{dx} - u \\cdot \\frac{dv}{dx}}{v^2}$. What is $f\'(x)$?',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: '5-4',
        question: 'What is $\\frac{dv}{dx}$? (This requires the chain rule)',
        expectedAnswer: '2*e^(2x)',
        hint: 'The derivative of $e^u$ is $e^u \\cdot \\frac{du}{dx}$.',
      },
      {
        id: '5-5',
        question: 'Apply the product rule: $f\'(x) = u\\frac{dv}{dx} + v\\frac{du}{dx}$. What is $f\'(x)$?',
